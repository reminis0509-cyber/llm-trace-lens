...
FujiTrace を PostgreSQL のみで本番運用するための完全ガイドです。
...
```sql
-- =====================================================
-- FujiTrace - PostgreSQL Schema for Production
-- Version: 1.0.0
-- =====================================================
