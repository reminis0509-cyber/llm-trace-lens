const providers = [
  {
    name: 'OpenAI',
    models: ['GPT-4o', 'GPT-4o-mini', 'GPT-4', 'o1'],
    logo: (
  ...
  {
    name: 'Anthropic',
    models: ['Claude Opus 4', 'Claude Sonnet 4', 'Claude 3.5'],
    logo: (
      <svg className="w-10 h-10" viewBox="0 0 24 24" fill="currentColor">
        <path d="M17.304 3.541l-5.357 16.918H8.688l5.357-16.918h3.259zm-10.607 0l5.357 16.918H8.795L3.438 3.541h3.259z" />
      </svg>
    ),
  },
  {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
            主要<span className="gradient-text">LLMプロバイダ</span>に対応
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            すべてのプロバイダでストリーミング対応。統一されたインターフェースで管理
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {providers.map((provider, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-6 hover:border-primary-300 hover:shadow-md transition-all"
            >
              <div className="w-16 h-16 bg-gray-100 rounded-xl flex items-center justify-center mb-4 text-gray-700">
                {provider.logo}
              </div>
