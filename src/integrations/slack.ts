...
export class SlackIntegration {
  ...
  async sendBlockNotification(
    ...
    const message: SlackBlockKitMessage = {
      text: `${emoji} [FujiTrace] ${riskLevel.toUpperCase()} Risk Detected`,
      blocks: [
        {
          type: 'header',
          text: {
  ...
  async sendTestNotification(webhookUrl: string): Promise<boolean> {
    const testMessage: SlackBlockKitMessage = {
      text: 'FujiTrace - Test Notification',
      blocks: [
        {
          type: 'header',
          text: {
            type: 'plain_text',
            text: 'FujiTrace Connection Test',
            emoji: true,
          },
        },
        {
          ...
          text: {
            type: 'mrkdwn',
            text: 'This is a test notification from FujiTrace. If you see this message, your Slack integration is working correctly!',
          },
        },
        {
          type: 'context',
