...
## 料金プラン
- Free: ¥0/月、5,000トレース、7日保持、1シート
- Pro: ¥9,800/月（年額¥105,840で10%割引）、50,000トレース、90日保持、無制限シート、LLM評価1,000回/月
- Enterprise Standard: ¥300,000/年（年次契約のみ）、100,000トレース、180日保持、業界ベンチマーク、SLA 99.5%
- Enterprise Plus: ¥960,000/年、500,000トレース、365日保持、SSO/SAML、SLA 99.9%
- Enterprise Premium: ¥2,400,000〜/年、個別見積、無制限保持、SLA 99.95%、オンプレ対応
- 超過料金: トレース¥200-300/万、評価¥100-200/千回
